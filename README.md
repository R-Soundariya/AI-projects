...
A collection of small AI-powered projects.
...
| 5 | [🗂️ Customer Feedback Analyzer](customer-feedback-analyzer/) | Python + Streamlit app that batches raw feedback through an LLM for sentiment/theme tagging, then aggregates in tested Python into ranked, quotable themes. | [Run locally](customer-feedback-analyzer/#how-to-run) — Python app, see README |
